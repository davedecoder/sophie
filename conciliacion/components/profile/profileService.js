    ...
    function intHistObjt(those){
        ...
        console.log(user) 
            var data = angular.toJson({
                    ...
                    identificadorPacienteDatosClinicos: (user.identificadorPacienteDatosClinicos != undefined) ? user.identificadorPacienteDatosClinicos.toString() : undefined,
                    camaDatosClinicos: (user.camaDatosClinicos != undefined) ? user.camaDatosClinicos.toString() : undefined,
                ...
                $http.put(url+"clinicalData/"+user.idDatosClinicos,data).then(function(response){
                    console.log(response)
                    $route.reload(); 
                });
        ...
        function putPD(user){
                ...
                $http.put(url+"patient/"+user.idPaciente,data).then(function(response){
                    console.log(response);
                    $route.reload();
                });
        }
